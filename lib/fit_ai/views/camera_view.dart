  ...
  void didUpdateWidget(covariant CameraView oldWidget) {
    if (widget.customPaint != oldWidget.customPaint) {
      ...
      for (final pose in widget.posePainter!.poses) {
        ...
        var p1 = getPoseLandmark(PoseLandmarkType.rightShoulder);
        var p2 = getPoseLandmark(PoseLandmarkType.rightElbow);
        var p3 = getPoseLandmark(PoseLandmarkType.rightWrist);
